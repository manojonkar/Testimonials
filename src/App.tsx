...
const Avatar = ({
  ...
  return (
    <div
      className={`${sizeClasses[size]} rounded-full overflow-hidden border border-white/20 bg-white/5 flex items-center justify-center`}
    >
      {!error && src ? (
        <img
          src={src}
    ...
    <div className="min-h-screen bg-luxury-bg text-white selection:bg-luxury-accent selection:text-white">
      ...
      <nav className="fixed top-0 w-full z-50 glass px-6 py-4 flex justify-between items-center">
        <div className="flex items-center gap-2">
          <div className="w-8 h-8 bg-luxury-accent rounded-lg flex items-center justify-center font-bold text-black">
            O
          </div>
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="px-5 py-2 bg-luxury-accent/10 text-luxury-accent rounded-full text-xs font-bold border border-luxury-accent/20 hover:bg-luxury-accent hover:text-black transition-all"
          >
            ODeX
          </a>
        </div>
      ...
      <main>
        ...
        <section className="relative h-screen flex items-center justify-center overflow-hidden px-6">
          ...
          <motion.div style={{ opacity, scale }} className="relative z-10 text-center max-w-4xl">
            ...
            >
              ...
              <span className="text-[10px] uppercase tracking-[0.2em] font-bold text-luxury-accent">
                Transformative ODeX Journey
              </span>
            </motion.div>
            ...
            >
              Real stories from leaders who pushed boundaries, challenged assumptions, and
              redefined their purpose through the ODeX program.
            </motion.p>
            ...
            >
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="px-8 py-4 bg-luxury-accent text-black font-bold rounded-full hover:bg-white transition-all"
              >
                Know More
              </a>
              <a
                href="#featured"
                className="px-8 py-4 bg-white/10 text-white font-bold rounded-full hover:bg-white/20 transition-all border border-white/10"
              >
                Featured Story
              </a>
              <a
              ...
              >
                <div>
                  ...
                  <h2 className="text-4xl md:text-6xl font-serif mb-8 leading-tight">
                    "{testimonials[featuredIndex].text.substring(0, 80)}
                    <span className="italic text-luxury-accent">...</span>"
                  </h2>
                  ...
                  <div className="flex items-center gap-6">
                    <Avatar
                      ...
                      name={testimonials[featuredIndex].name}
                      size="lg"
                    />
                    <div>
                      ...
                      <p className="text-[10px] text-luxury-accent uppercase tracking-widest">
                        {testimonials[featuredIndex].company}
                      </p>
                    </div>
                  </div>
                  <button
              ...
              {testimonials.map((_, i) => (
                <button
                  ...
                  className={`h-1 transition-all duration-500 rounded-full ${
                    i === featuredIndex ? 'w-12 bg-luxury-accent' : 'w-4 bg-white/20'
                  }`}
                />
              ))}
            </div>
        ...
        <section className="py-10 px-6 max-w-7xl mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <StatCard icon={Users} label="Leaders Featured" value={`${testimonials.length}+`} />
            <StatCard icon={Award} label="Transformation" value="Real" />
            <StatCard icon={Zap} label="Journey" value="6 Months" />
            <StatCard icon={Sparkles} label="Impact" value="Deep" />
          </div>
        </section>
        ...
        <section id="testimonials" className="py-32 px-6 max-w-7xl mx-auto">
          <div className="text-center mb-20">
            ...
            <p className="text-white/40 max-w-xl mx-auto">
              Hear directly from the senior professionals and business leaders who have
              experienced the ODeX transformation.
            </p>
          </div>
              ...
              >
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-luxury-accent uppercase tracking-widest mt-1">
                      {t.company}
                    </p>
                  </div>
                </div>
                ...
                <div className="relative mb-6">
                  ...
                  <div className="relative z-10">
                    <ParagraphText
                      text={t.text}
                      addQuotes={true}
                      className="text-white/80 font-light leading-relaxed italic"
                    />
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between pt-6 border-t border-white/5">
                  ...
                  <div className="flex gap-1">
                    {[...Array(5)].map((_, starIndex) => (
                      <Star
                        key={starIndex}
                        className="w-3 h-3 text-luxury-accent fill-luxury-accent"
                      />
                    ))}
                  </div>
                </div>
        ...
        <section className="py-32 px-6 max-w-7xl mx-auto border-t border-white/5">
          <div className="text-center mb-20">
            <h2 className="text-4xl md:text-6xl font-serif mb-6">
              The <span className="text-luxury-accent italic">Destination</span>
            </h2>
            <p className="text-white/40 max-w-xl mx-auto">
              What is an Extraordinary Organization? It goes far beyond hitting quarterly
              numbers. It's a new vision for what your organization can become.
            </p>
          </div>
          <div className="grid md:grid-cols-3 gap-12">
            ...
            >
              ...
              <p className="text-white/40 leading-relaxed">
                Nimble, adaptive, and built to pivot, ready for whatever curveballs the world
                throws at it.
              </p>
            </motion.div>
            <motion.div
            ...
            >
              ...
              <p className="text-white/40 leading-relaxed">
                A place where people bring their whole selves to work: their Head
                (intellect), Heart (passion), and Soul (deep commitment).
              </p>
            </motion.div>
            <motion.div
              whileHover={{ scale: 1.05 }}
            ...
            >
              ...
              <p className="text-white/40 leading-relaxed">
                It's not just about profit. It's about making a real, positive difference in
                the world and leaving a lasting mark.
              </p>
            </motion.div>
          </div>
        </section>
        ...
        <section id="highlights" className="py-32 px-6 max-w-7xl mx-auto">
          <div className="text-center mb-20">
            <h2 className="text-4xl md:text-6xl font-serif mb-6">
              The ODeX <span className="text-luxury-accent italic">Roadmap</span>
            </h2>
            <p className="text-white/40 max-w-xl mx-auto">
              A complete, integrated system designed to build greatness from the ground up,
              weaving leadership, culture, strategy, and talent into one actionable plan.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 h-auto md:h-[900px]">
            ...
            >
              ...
              <div>
                ...
                <p className="text-xl text-white/60 font-light leading-relaxed max-w-xl">
                  Develop collective leadership where everyone takes initiative, collaborates,
                  and co-creates the future. Break down silos and shift to an outside-in,
                  customer-focused view across the entire organization.
                </p>
              </div>
              <div className="mt-12 flex items-center gap-4">
                <div className="px-6 py-3 bg-white/5 rounded-full border border-white/10 text-xs uppercase tracking-widest font-bold">
            ...
            >
              ...
              <p className="text-sm text-white/40 leading-relaxed">
                Become truly unique and compelling in the eyes of your target customers.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-sm text-white/40 leading-relaxed">
                Get everyone in the company aligned and playing the same game in a
                synchronized way.
              </p>
            </motion.div>
              ...
              <div className="flex items-center gap-8">
                ...
                <div>
                  ...
                  <p className="text-white/40 max-w-md">
                    Learn the fundamentals of attracting, training, and managing the right
                    people to fuel the entire system.
                  </p>
                </div>
              </div>
              <a
        ...
        <section className="py-32 px-6 max-w-7xl mx-auto border-t border-white/5">
          <div className="text-center mb-20">
            <h2 className="text-4xl md:text-6xl font-serif mb-6">
              An <span className="text-luxury-accent italic">Elite</span> Experience
            </h2>
            <p className="text-white/40 max-w-xl mx-auto">
              Not another training seminar. This is an elite development experience crafted
              for leaders committed to transformative results.
            </p>
          </div>
          <div className="grid md:grid-cols-3 gap-12">
            <motion.div
            ...
            >
              ...
              <p className="text-white/40 leading-relaxed">
                Go beyond theory. Apply your learning directly to your biggest business
                challenges inside your own organization with full support.
              </p>
            </motion.div>
            <motion.div
              whileHover={{ y: -10 }}
            ...
            >
              ...
              <p className="text-white/40 leading-relaxed">
                Learn a curated suite of proven management technologies from faculty with
                decades of real-world experience transforming businesses.
              </p>
            </motion.div>
            <motion.div
              whileHover={{ y: -10 }}
            ...
            >
              ...
              <p className="text-white/40 leading-relaxed">
                The entire program is laser-focused on one thing: generating tangible,
                measurable outcomes that you can see in real-time.
              </p>
            </motion.div>
          </div>
        </section>
        ...
        <section className="py-32 px-6 max-w-7xl mx-auto border-t border-white/5">
          <div className="text-center mb-20">
            <h2 className="text-4xl md:text-6xl font-serif mb-6">
              The ODeX <span className="text-luxury-accent italic">Journey</span>
            </h2>
            <p className="text-white/40 max-w-xl mx-auto">
              Real transformation doesn't happen in a weekend. It takes sustained effort to
              build new habits and systems that stick.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="glass p-8 rounded-3xl border border-white/5">
              ...
              <p className="text-sm text-white/40">
                One intensive weekend per month to create a new dimension of understanding in
                OD and Leadership.
              </p>
            </div>
            <div className="glass p-8 rounded-3xl border border-white/5">
              ...
              <p className="text-sm text-white/40">
                Weekly 2-hour sessions to deepen learnings and get implementation support for
            ...
            <div className="glass p-8 rounded-3xl border border-white/5">
              ...
              <p className="text-sm text-white/40">
                Part of a dedicated team of 4-5 participants, providing support,
                accountability, and holistic development.
              </p>
            </div>
            <div className="glass p-8 rounded-3xl border border-white/5">
              ...
              <p className="text-sm text-white/40">
                Get live support for starting and implementing a transformational project
                right inside your own organization.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            <div className="relative max-w-sm mx-auto lg:mx-0">
              <div className="aspect-square rounded-[2rem] overflow-hidden glass p-2">
                <img
                  src="src="src="src="src="https://i.ibb.co/6cNNKw2k/manoj.jpg" 
                  className="w-full h-full object-cover rounded-[1.5rem] grayscale hover:grayscale-0 transition-all duration-700"
                  alt="Manoj Onkar"
                  referrerPolicy="no-referrer"
                />
              ...
              <div className="absolute -bottom-24 -left-8 lg:-left-32 glass p-6 rounded-3xl border border-white/10 max-w-[260px] z-20">
                <p className="text-sm font-serif italic mb-4">
                  "His teaching style is dynamic, energetic, and highly motivational, making
                  even complex subjects easy to grasp and apply."
                </p>
            ...
            <div>
              <h2 className="text-4xl md:text-6xl font-serif mb-8">
                Meet Your <span className="text-luxury-accent italic">Faculty</span>
              </h2>
              ...
              <div className="space-y-8">
                <div className="flex gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-white/40 text-sm">
                      Deep expertise in individual and organizational transformation across
                      diverse sectors.
                    </p>
                  </div>
                </div>
                <div className="flex gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-white/40 text-sm">
                      Empowered over 50,000 individuals and 200+ trainers, coaches, and
                ...
                <div className="flex gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-white/40 text-sm">
                      Participants from 10+ countries and 30+ industries have benefited from
        ...
        <section className="py-32 px-6 text-center">
          ...
          >
            ...
            <span className="text-xs uppercase tracking-[0.2em] font-bold text-luxury-accent">
              Next Cohort: April 2026 — Sept 2026
            </span>
          </motion.div>
          <h2 className="text-4xl md:text-7xl font-serif mb-8 tracking-tight">
            Ready to transform?
          </h2>
          <p className="text-white/40 mb-16 max-w-2xl mx-auto text-xl font-light leading-relaxed">
            Join an elite group of founders and CEOs in this 6-month immersive journey to
          ...
          <div className="mt-16 flex flex-col items-center gap-4">
            ...
            <div className="flex gap-8 items-center">
              <span className="text-2xl font-serif text-white/60">
                INR 3L <span className="text-xs font-sans">+ tax</span>
              </span>
              ...
              <div className="p-12 overflow-y-auto custom-scrollbar">
                ...
                <div className="flex items-center gap-6 mb-12">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-luxury-accent uppercase tracking-[0.2em] mt-2">
                ...
                <div className="relative mb-12">
                  ...
                  <div className="relative z-10 pr-8">
                    <ParagraphText
                      ...
                      addQuotes={true}
                      className="text-2xl font-serif italic leading-relaxed text-white/90"
                    />
                  </div>
                </div>
              </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-4 gap-12 mb-20">
            <div className="col-span-2">
              <div className="flex items-center gap-3 mb-8">
                <div className="w-10 h-10 bg-luxury-accent rounded-xl flex items-center justify-center font-bold text-black">
                  O
                </div>
                <span className="font-serif text-2xl tracking-tight">ODeX Wall of Love</span>
              </div>
              <p className="text-white/40 max-w-sm leading-relaxed">
                Transforming organizational development through deep listening, strategic
                thinking, and massive transformative purpose.
              </p>
            </div>
            <div>
              <h4 className="text-xs uppercase tracking-widest text-luxury-accent font-bold mb-6">
                Program
              </h4>
              <ul className="space-y-4 text-sm text-white/60">
                <li>
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="hover:text-white transition-colors font-bold text-luxury-accent"
                  >
                    ODeX Official Page
                  </a>
                </li>
          ...
          <div className="pt-12 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-6">
            <p className="text-white/20 text-xs tracking-widest uppercase">
              © 2026 ODeX. Built with Gemini 2.5 & Veo AI.
            </p>
            <div className="flex gap-8">
              <a
                href="#"
                className="text-[10px] text-white/20 hover:text-luxury-accent transition-colors uppercase tracking-widest"
              >
                Privacy Policy
              </a>
              <a
